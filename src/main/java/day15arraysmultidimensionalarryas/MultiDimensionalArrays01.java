...
public class MultiDimensionalArrays01 {
    ...
    public static void main(String[] args) {
        ...
        // "multidimensional Array i console nasil yazdirilir.
        System.out.println(Arrays.deepToString(arr));//[[3, -4], [6, 18], [-7, 0]]

        //"Multidimensional Array"lerde Array elemenalardan biri nasil yazdirilir?
        System.out.println(Arrays.toString(arr[1]));//[6, 18]

        //"Multidimensional Array"lerde ic Arraylerdeki elemenalar nasil yazdirilir?
        System.out.println(arr[1][0]);//6

        //Example 1; String bir Multidimensional Array olusturunuz.
        //          Elemanlarini ekleyini.
        //          Sonra da toplam elaman sayisini ekrana yazdiran kodu yaziniz.
